...
public class ThreadInfoDao extends AbstractDao<ThreadInfo, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Start = new Property(1, Integer.class, "start", false, "START");
        public final static Property Stop = new Property(2, Integer.class, "stop", false, "STOP");
        public final static Property Finished = new Property(3, Integer.class, "finished", false, "FINISHED");
    ...
    protected void bindValues(SQLiteStatement stmt, ThreadInfo entity) {
        ...
        Integer stop = entity.getEnd();
        if (stop != null) {
            stmt.bindLong(3, stop);
        }
 
        Integer finished = entity.getFinished();
        if (finished != null) {
            stmt.bindLong(4, finished);
        }
    ...
    public ThreadInfo readEntity(Cursor cursor, int offset) {
        ThreadInfo entity = new ThreadInfo( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1), // start
            cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2), // stop
            cursor.isNull(offset + 3) ? null : cursor.getInt(offset + 3), // finished
    ...
    public void readEntity(Cursor cursor, ThreadInfo entity, int offset) {
        ...
        entity.setStart(cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1));
        entity.setEnd(cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2));
        entity.setFinished(cursor.isNull(offset + 3) ? null : cursor.getInt(offset + 3));
